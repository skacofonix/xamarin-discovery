...
namespace SmartConnect.Common
{
    ...
    public class ObservableRangeCollection<T> : ObservableCollection<T>
    {
        ...
        public void InsertRange(int index, IEnumerable<T> collection, NotifyCollectionChangedAction notificationMode = NotifyCollectionChangedAction.Add)
        {
            ...
            var coll = collection/*.Reverse()*/.ToList();
            if (notificationMode == NotifyCollectionChangedAction.Reset)
            {
            ...
            OnPropertyChanged(new PropertyChangedEventArgs("Count"));
            OnPropertyChanged(new PropertyChangedEventArgs("Item[]"));
            OnCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Add, coll, index));
        }
